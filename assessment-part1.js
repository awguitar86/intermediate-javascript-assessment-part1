...
"Hello! Isn't it a WONDERFUL day outside TODAY!".grammarPolice();
...
// CODE HERE...
let valueType = (one, two) => one === two ? "Exactly the same" : one == two ? "Same value, different types" : "Different values";
